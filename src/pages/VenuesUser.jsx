  ...
  return (
    <div className="relative px-5 pt-3  lg:px-7">
      ...
      <div className="flex justify-between items-center mb-8 mt-6">
        <h1 className='font-semibold text-lg lg:text-[30px]'>Venue Users</h1>
        <input
          type="text"
          placeholder="Search..."
          value={searchTerm}
          ...
          <tbody>
            {paginatedUsers.map((user) => (
              ...
              >
                ...
                <td className="px-3 py-3 ">{user.manualVerification}</td>
                <td className="px-3 py-3 ">{user.verificationDate}</td>
                <td className="px-3 py-3 ">{user.verificationStatus}</td>
                <td className="px-3 py-3 ">{user.suppressed}</td>
                <td className="px-3 py-3 ">{user.addDate}</td>
              </tr>
            ))}
          </tbody>
        </table>
